...
FORESHADOWING_STATUS_PENDING = "pending"
FORESHADOWING_STATUS_RESOLVED = "resolved"

FORESHADOWING_TIER_CORE = "core"
FORESHADOWING_TIER_SUB = "sub"
FORESHADOWING_TIER_DECOR = "decor"
...
_PENDING_STATUS_TEXT = {"not_recovered", "pending_recovery", "in_progress", "unresolved", "pending", "active", "unresolved", "pending_payoff"}
_RESOLVED_STATUS_TEXT = {"recovered", "completed", "resolved", "done", "resolved", "done", "complete", "paid_off"}

_TIER_CORE_TEXT = {"core", "main_line", "core", "main"}
_TIER_DECOR_TEXT = {"decorative", "secondary", "decor", "decoration"}
