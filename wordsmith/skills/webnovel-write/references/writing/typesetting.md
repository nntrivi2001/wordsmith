...
10. New entity first appearance clear (name/identity/memory point); if manual annotation needed (optional): use hidden XML tags (see `${CLAUDE_PLUGIN_ROOT}/skills/webnovel-query/references/tag-specification.md`)
